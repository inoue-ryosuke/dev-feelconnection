...
class CreateBelongTenpoHistTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('belong_tenpo_hist__c', function (Blueprint $table) {
            ...
            $table->dateTime('end__c')->nullable()->comment('店舗所属終了日');
    ...
    {
        Schema::drop('belong_tenpo_hist__c');
    }
}
